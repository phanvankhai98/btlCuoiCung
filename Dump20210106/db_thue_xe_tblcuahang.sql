...
CREATE TABLE `tblcuahang` (
  ...
  KEY `fk_tblcuahang_tbldiachi_idx` (`iddiachi`),
  CONSTRAINT `fk_tblcuahang_tbldiachi` FOREIGN KEY (`iddiachi`) REFERENCES `tbldiachi` (`id`)
...
INSERT INTO `tblcuahang` VALUES (1,'cua hang','cua hang',1);
