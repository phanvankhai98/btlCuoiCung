...
CREATE TABLE `tblhopdong` (
  ...
  `ngaythue` int DEFAULT NULL,
  `ngaytra` int DEFAULT NULL,
  `idkhachhang` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_tblhopdong_tblnguoi_idx` (`idkhachhang`),
  CONSTRAINT `fk_tblhopdong_tblkhach` FOREIGN KEY (`idkhachhang`) REFERENCES `tblnguoi` (`id`)
...
INSERT INTO `tblhopdong` VALUES (1,'thuê xe','thuê xe',100,'usd',20130410,20134410,2);
