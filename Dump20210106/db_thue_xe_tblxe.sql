...
CREATE TABLE `tblxe` (
  ...
  `iddongxe` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_tblxe_tbldongxe_idx` (`iddongxe`),
  CONSTRAINT `fk_tblxe_tbldongxe` FOREIGN KEY (`iddongxe`) REFERENCES `tbldongxe` (`id`)
...
INSERT INTO `tblxe` VALUES (1,'c500','c500',1);
