...
// where tblxe.iddongxe = tbldongxe.id and tbldongxe.idhangxe = tblhangxe.id;
    public List<Xe> getAll() {
        ...
        String sql = "SELECT tblxe.id,tblxe.ten,tblxe.mota,tblxe.dongia,tblxe.bienso,tbldongxe.ten as dongxe, tblhangxe.ten as hangxe\n"
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xe.setBienSO(rs.getString("bienso"));
                 xe.setDonGia(rs.getDouble("dongia"));
